...
public class Solution {
    ...
    public static void printMatrix(short i, int n, String value) {
    }
    ...
    public static void printMatrix(String n, String value) {
    }
    public static void printMatrix(boolean n, String value) {
    }
    public static void printMatrix(Integer n, String value) {
    }
}
